    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-xl-12 col-lg-12">
                <button class="btn btn-primary default float-right addNewCustomer iconsmind-Add-UserStar"> Add New Customer</button>
            </div>
            <div class="col-xl-12 col-lg-12">
                        ...
                        <table class="data-table responsive nowrap" data-order="[[ 1, &quot;desc&quot; ]]">
                            ...
                            <tbody>
                                ...
                                <tr class="user_<?php echo $user->id;?>">
                                    ...
                                    <td>
                                        <p class="text-muted expiration"><?php echo ($user->expiration == "0000-00-00" ? "" : $user->expiration) ;?></p>
                                    </td>
                                    <td>
                    ...
                    <div class="modal-body user-info">
                        <div class="row">
                            ...
                            <div class="col col-md-6 col-sm-6 col-xs-6 mt-2">
                                ...
                                <input type="type" disabled id="expiration" />
                            </div>
                            <div class="col col-md-6 col-sm-6 col-xs-6 mt-2">
                                <label>Address </label>
